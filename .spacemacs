...
(custom-set-variables
 ...
 '(connection-local-criteria-alist
   '(((:application eshell)
     ...
     ((:application tramp :machine "eli.Ljugarn-Guest")
      tramp-connection-local-darwin-ps-profile)
     ((:application tramp)
