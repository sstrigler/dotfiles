...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     (erlang :variables
             erlang-backend 'lsp
             erlang-root-dir "/home/zeank/.asdf/installs/erlang/27.2"
